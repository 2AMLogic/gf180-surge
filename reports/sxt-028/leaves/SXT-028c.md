**Epic:** #3 (effects expansion) · **Plan:** docs/surge-xt-chip-plan-v0.1-2026-09-20.md §6 (SXT-028 row) · planning ID: SXT-028c · raised by SXT-028 (#21)
...
One algorithm per leaf: Chorus effect leaf (sst-effects Chorus, delay-line class). Preserves per-instance state and tails under the shared instance schedule; no monolithic FX port.

## Recovery ordering (diagnostic)
Ordered by measured SXT-014 ablation delta: max mean block-RMS Δ 2.083 dB (diagnostic only). Provenance: reports/sxt-014/deltas/fmcombo/seq-notes-coverage-v1-bypass-slot01-Chorus.json; reports/sxt-014/deltas/fmcombo/seq-poly-8-v1-bypass-slot01-Chorus.json.

## Scope and pinned sources

- libs/sst/sst-effects@adcac6950292dacc529651093e7ece2d1c8c0d4b/include/sst/effects/Chorus.h (ChorusEffect: initialize/setvars/processBlock; nested ChorusEffectBase lags and LFO phase)
- libs/sst/sst-effects@adcac6950292dacc529651093e7ece2d1c8c0d4b/include/sst/effects/EffectCore.h
- surge-synthesizer/surge@58914e59c608ed4384ba6002e44c3465c58b2e71: src/common/dsp/effects/SurgeSSTFXAdapter.h (envelopeRateLinear/temposyncRatio adapters)
...
> **SXT-017 decision required (#12):** Chorus shares Delay's LFO-modulated delay-line semantics; the open delay-budget finding (SXT-023 diagnosis: LFO term presence in the delay-time path, reports/sxt-023/delay-budget-diagnosis.md) applies to the Chorus delay time path too. SXT-017 DECISION REQUIRED before any Chorus reference budget freezes; coordinate with #16.

## Fixtures plan

- SXT-014 pilot carrier exists: resources/data/patches_factory/Basses/FM Combo.fxp (factory, blob b50a36498d69...) -- reuse the committed SXT-012 fixture WAVs + SXT-014 ablation tree for the comparability leg (same engine pin, sequences, policies); no re-render needed for that leg.
- Proposed additional fixture presets (B4-scope carriers, census-blob sha verified at render): resources/data/patches_3rdparty/A.Liv/Leads/Novuo.fxp (contributor, blob e688adfdcdee...); resources/data/patches_3rdparty/Altenberg/Basses/Ancient FM.fxp (contributor, blob 9e796f283f2d...); resources/data/patches_3rdparty/Altenberg/Basses/Piercing.fxp (contributor, blob d02d14ea299b...)
...
- model/effects/type-chorus/ -- frozen fixed-point model + README (word lengths, state layout, per-instance state ownership) (model/effects/README.md pattern)
- model/effects/fx_inputs/type-chorus-*.json -- fail-closed input extraction (extract_fx_inputs.py pattern; census blob re-verified, graphs cross-check, drift asserted 0)
- rtl/effects/type-chorus/ -- RTL + iverilog testbench incl. the dual-instance and negative-control benches
- reports/SXT-028c/ -- EVIDENCE.md: verification statuses PASS/FAIL/NOT_RUN/BLOCKED, budgets vs achieved, coverage separate from agreement, ext-mem estimate [PENDING-SXT-016]
- tests/test_sxt028c.py -- generator-consistency + exactness harness guards (oracle-dependent tests skip NOT_RUN without oracle)
...
- Strict-FX-complete: 175 presets; B4-scope candidates (upper bound): 331 (factory 25, contributor 306).
...
- Hashes: reports/sxt-028/leaves/SXT-028c/newly-enabled.json (full path + blob-SHA-1 lists).
